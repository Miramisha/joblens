...
with tempfile.TemporaryFile() as logs:
    ...
    try:
        ...
        for name in ['email-auth-smoke.py', 'account-export-smoke.py', 'account-restore-smoke.py', 'scheduled-backup-smoke.py', 'account-delete-smoke.py', 'maintenance-smoke.py', 'api-smoke.py']:
